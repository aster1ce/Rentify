...
<div class="form-container">
    <div class="form-card">
        <div class="mb-4">
            ...
            <p class="text-muted small">Kelompokkan alat Anda agar lebih mudah dicari oleh peminjam.</p>
        </div>
        ...
        <form action="<?= base_url('alat/proses_tambah_kategori') ?>" method="post">
            <div class="mb-4">
                ...
                <div class="input-group has-icon">
                    <span class="input-group-text"><i class="bi bi-grid-plus"></i></span>
                    <input type="text" name="nama_kategori" class="form-control"
                        placeholder="Misal: Multimedia, Audio, Lighting" required>
                </div>
                <div class="form-text mt-2" style="font-size: 0.75rem;">
                    Gunakan nama yang umum dan mudah dipahami.
                </div>
            </div>
            ...
            <div class="d-flex align-items-center mt-4">
                ...
                <a href="<?= base_url('alat/index/kategori') ?>" class="btn-cancel">
                    Batal
                </a>
            </div>
        </form>
